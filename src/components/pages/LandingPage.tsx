          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            >
              ...
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight text-gray-900">
                Votre équipe <span className="text-blue-600">web</span>,{' '}
              ...
              <p className="text-lg text-gray-600 leading-relaxed max-w-xl font-normal">
                PROGIX Studio conçoit et développe des produits digitaux livrés
                dans les temps, maintenables sur le long terme, et compétitifs
                en budget — grâce à une équipe senior et une méthode orientée
                impact.
              </p>
            ...
            {[
              {
                ...
                description:
                  'Sites web modernes, applications web complexes et e-commerce performants',
              },
              {
                icon: <FaMobile size={48} />,
                title: 'Applications Mobile',
                description:
                  'Apps iOS et Android natives ou cross-platform avec React Native',
              },
              {
                icon: <MdAnalytics size={48} />,
                title: 'Data & Analytics',
                description:
                  'Solutions de data science, BI et intelligence artificielle',
              },
              {
                icon: <MdSecurity size={48} />,
                title: 'Sécurité',
                description:
                  'Audit de sécurité, protection des données et conformité RGPD',
              },
              {
                icon: <FaRocket size={48} />,
                title: 'DevOps & Cloud',
                description:
                  'Déploiement cloud, CI/CD et infrastructure scalable',
              },
              {
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  'Méthodologie agile pour des résultats en temps record',
              },
              {
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Depuis 2020, PROGIX accompagne les entreprises dans leur
                transformation digitale. Notre équipe de passionnés combine
                expertise technique et vision business pour créer des solutions
            ...
            >
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="aspect-square bg-gray-200 rounded-2xl flex items-center justify-center"
                >
