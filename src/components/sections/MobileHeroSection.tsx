...
const MobileHeroSection = () => {
  return (
    <section className="relative h-dvh flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#14243a] via-[#1e3a56] to-[#14243a]">
      ...
      >
        ...
        >
          <CircularText
            text="SCROLL • MOBILE DELIVERY • SCROLL • MOBILE DELIVERY • "
            spinDuration={15}
            onHover="speedUp"
