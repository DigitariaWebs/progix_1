...
const Section: React.FC<SectionProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-white font-semibold text-[15px] md:text-[16px]">
          {title}
        </h2>
        <motion.span
    ...
    <div className={`${barlow.className} pb-24`}>
      ...
      <header className="pt-[140px] md:pt-[180px] pb-8 md:pb-16">
        <div className="max-w-[1200px] mx-auto px-6 md:px-10 lg:px-16">
          <motion.p
            ...
            className="uppercase tracking-[0.12em] text-[11px] text-white"
          >
            devis
          </motion.p>
          <motion.h1
          ...
          <motion.p
            ...
            className="mt-8 md:mt-10 max-w-[520px] text-white font-medium text-[15px] md:text-[16px]"
          >
      ...
      <Section id="sec-qui" index={4} title="Qui?">
        <div className="mt-2 grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div>
            <p className="text-white font-medium text-[15px] md:text-[16px] max-w-[520px]">
            ...
            <div className="mt-8 space-y-8 max-w-md">
              <div>
                ...
                <input
                  className="w-full bg-transparent border-b border-white/20 focus:border-white/40 outline-none py-3 text-[14px] placeholder-white/30"
                  placeholder=""
                />
              </div>
              <div>
          ...
          <div>
            ...
            <textarea
              rows={8}
              className="w-full bg-transparent border-b border-white/20 focus:border-white/40 outline-none py-3 text-[14px] placeholder-white/30 min-h-[220px]"
              placeholder=""
            />
          </div>
        </div>
